...
namespace Cacao {
	...
	unsigned int WaylandWindowImpl::ConvertKeycode(unsigned int key) {
		constexpr const static auto codes = mapbox::eternal::map<unsigned int, unsigned int>({{XKB_KEY_Return, CACAO_KEY_ENTER},
			...
			{XKB_KEY_1, CACAO_KEY_1},
			{XKB_KEY_2, CACAO_KEY_2},
			{XKB_KEY_3, CACAO_KEY_3},
			{XKB_KEY_4, CACAO_KEY_4},
			{XKB_KEY_5, CACAO_KEY_5},
			{XKB_KEY_6, CACAO_KEY_6},
			{XKB_KEY_7, CACAO_KEY_7},
			{XKB_KEY_8, CACAO_KEY_8},
			{XKB_KEY_9, CACAO_KEY_9},
			{XKB_KEY_semicolon, CACAO_KEY_SEMICOLON},
			{XKB_KEY_bracketleft, CACAO_KEY_LEFT_BRACKET},
			{XKB_KEY_bracketright, CACAO_KEY_RIGHT_BRACKET},
			{XKB_KEY_backslash, CACAO_KEY_BACKSLASH},
			{XKB_KEY_grave, CACAO_KEY_GRAVE_ACCENT},
			{XKB_KEY_a, CACAO_KEY_A},
			{XKB_KEY_b, CACAO_KEY_B},
			{XKB_KEY_c, CACAO_KEY_C},
			{XKB_KEY_d, CACAO_KEY_D},
			{XKB_KEY_e, CACAO_KEY_E},
			{XKB_KEY_f, CACAO_KEY_F},
			{XKB_KEY_g, CACAO_KEY_G},
			{XKB_KEY_h, CACAO_KEY_H},
			{XKB_KEY_i, CACAO_KEY_I},
			{XKB_KEY_j, CACAO_KEY_J},
			{XKB_KEY_k, CACAO_KEY_K},
			{XKB_KEY_l, CACAO_KEY_L},
			{XKB_KEY_m, CACAO_KEY_M},
			{XKB_KEY_n, CACAO_KEY_N},
			{XKB_KEY_o, CACAO_KEY_O},
			{XKB_KEY_p, CACAO_KEY_P},
			{XKB_KEY_q, CACAO_KEY_Q},
			{XKB_KEY_r, CACAO_KEY_R},
			{XKB_KEY_s, CACAO_KEY_S},
			{XKB_KEY_t, CACAO_KEY_T},
			{XKB_KEY_u, CACAO_KEY_U},
			{XKB_KEY_v, CACAO_KEY_V},
			{XKB_KEY_w, CACAO_KEY_W},
			{XKB_KEY_x, CACAO_KEY_X},
			{XKB_KEY_y, CACAO_KEY_Y},
			{XKB_KEY_z, CACAO_KEY_Z},
			{XKB_KEY_Caps_Lock, CACAO_KEY_CAPS_LOCK},
			{XKB_KEY_F1, CACAO_KEY_F1},
			{XKB_KEY_F2, CACAO_KEY_F2},
			{XKB_KEY_F3, CACAO_KEY_F3},
			{XKB_KEY_F4, CACAO_KEY_F4},
			{XKB_KEY_F5, CACAO_KEY_F5},
			{XKB_KEY_F6, CACAO_KEY_F6},
			{XKB_KEY_F7, CACAO_KEY_F7},
			{XKB_KEY_F8, CACAO_KEY_F8},
			{XKB_KEY_F9, CACAO_KEY_F9},
			{XKB_KEY_F10, CACAO_KEY_F10},
			{XKB_KEY_F11, CACAO_KEY_F11},
			{XKB_KEY_F12, CACAO_KEY_F12},
			{XKB_KEY_Print, CACAO_KEY_PRINT_SCREEN},
			{XKB_KEY_Scroll_Lock, CACAO_KEY_SCROLL_LOCK},
			{XKB_KEY_Pause, CACAO_KEY_PAUSE},
			{XKB_KEY_Insert, CACAO_KEY_INSERT},
			{XKB_KEY_Delete, CACAO_KEY_DELETE},
			{XKB_KEY_Home, CACAO_KEY_HOME},
			{XKB_KEY_Page_Up, CACAO_KEY_PAGE_UP},
			{XKB_KEY_End, CACAO_KEY_END},
			{XKB_KEY_Page_Down, CACAO_KEY_PAGE_DOWN},
			{XKB_KEY_Right, CACAO_KEY_RIGHT},
			{XKB_KEY_Left, CACAO_KEY_LEFT},
			{XKB_KEY_Down, CACAO_KEY_DOWN},
			{XKB_KEY_Up, CACAO_KEY_UP},
			{XKB_KEY_Num_Lock, CACAO_KEY_NUM_LOCK},
			{XKB_KEY_KP_Divide, CACAO_KEY_KP_DIVIDE},
			{XKB_KEY_KP_Multiply, CACAO_KEY_KP_MULTIPLY},
			{XKB_KEY_KP_Subtract, CACAO_KEY_KP_MINUS},
			{XKB_KEY_KP_Add, CACAO_KEY_KP_PLUS},
			{XKB_KEY_KP_Enter, CACAO_KEY_KP_ENTER},
			{XKB_KEY_KP_1, CACAO_KEY_KP_1},
			{XKB_KEY_KP_2, CACAO_KEY_KP_2},
			{XKB_KEY_KP_3, CACAO_KEY_KP_3},
			{XKB_KEY_KP_4, CACAO_KEY_KP_4},
			{XKB_KEY_KP_5, CACAO_KEY_KP_5},
			{XKB_KEY_KP_6, CACAO_KEY_KP_6},
			{XKB_KEY_KP_7, CACAO_KEY_KP_7},
			{XKB_KEY_KP_8, CACAO_KEY_KP_8},
			{XKB_KEY_KP_9, CACAO_KEY_KP_9},
			{XKB_KEY_KP_0, CACAO_KEY_KP_0},
			{XKB_KEY_KP_Decimal, CACAO_KEY_KP_PERIOD},
			{XKB_KEY_Control_L, CACAO_KEY_LEFT_CONTROL},
			{XKB_KEY_Shift_L, CACAO_KEY_LEFT_SHIFT},
			{XKB_KEY_Alt_L, CACAO_KEY_LEFT_ALT},
			{XKB_KEY_Super_L, CACAO_KEY_LEFT_SUPER},
			{XKB_KEY_Control_R, CACAO_KEY_RIGHT_CONTROL},
			{XKB_KEY_Shift_R, CACAO_KEY_RIGHT_SHIFT},
			{XKB_KEY_Alt_R, CACAO_KEY_RIGHT_ALT},
			{XKB_KEY_Super_R, CACAO_KEY_RIGHT_SUPER}});
