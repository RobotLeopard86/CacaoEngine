...
OBJECTS := $(OBJDIR)/glfwx_gl3_Backend.o $(OBJDIR)/glfwx_gl3_ImGui.o $(OBJDIR)/GLFWBackendComponent.o $(OBJDIR)/GLFWUtilities.o $(OBJDIR)/GLFWWindow.o $(OBJDIR)/OpenGLBackendComponent.o $(OBJDIR)/OpenGLMesh.o $(OBJDIR)/OpenGLMiscImpls.o $(OBJDIR)/OpenGLShader.o $(OBJDIR)/OpenGLTexture2D.o $(OBJDIR)/OpenGLCubemap.o $(OBJDIR)/OpenGLSkybox.o
...
$(OBJDIR)/OpenGLCubemap.o: $(SRCDIR)/Native/Common/OpenGL/OpenGLCubemap.cpp
	@echo "Compiling object $(notdir $@)... (source: $(notdir $<))"
	@$(cpp) $(OPTS) -o "$@" $<
