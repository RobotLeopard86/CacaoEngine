...
namespace Citrus {
	...
	void Shader::Compile(){
		...
		unsigned int ubi = glGetUniformBlockIndex(program, "CitrusData");
		Asserts::EngineAssert(ubi != GL_INVALID_INDEX, "Citrus Engine shader does not contain the CitrusData uniform block!");
