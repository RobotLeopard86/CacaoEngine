...
namespace Cacao {
	...
	class Logging {
	  public:
		 ...
		 */
		static void RuntimeLog(std::string message, LogLevel level = LogLevel::Info);
	  ...
	  private:
		static std::shared_ptr<spdlog::logger> engineStdout, engineLogfile, clientStdout, clientLogfile, rtStdout, rtLogfile;
	};
}